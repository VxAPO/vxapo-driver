...
impl ApoObjectState {
    ...
    pub fn is_pre_mix(&self) -> bool {
        self.clsid == super::reg_props::CLSID_VXAPO_PRE_MIX
    }

    /// 判断此实例是 PostMix APO。
    pub fn is_post_mix(&self) -> bool {
        self.clsid == super::reg_props::CLSID_VXAPO_POST_MIX
    }
...
mod tests {
    ...
    fn is_special_guid_real() {
        assert!(!is_special_guid(&super::super::reg_props::CLSID_VXAPO_PRE_MIX));
    }
    ...
    fn is_valid_apo_guid_real() {
        assert!(is_valid_apo_guid(&super::super::reg_props::CLSID_VXAPO_PRE_MIX));
    }
    ...
    fn apo_object_state_new() {
        let state = ApoObjectState::new(super::super::reg_props::CLSID_VXAPO_PRE_MIX);
    ...
    fn apo_object_state_post_mix() {
        let state = ApoObjectState::new(super::super::reg_props::CLSID_VXAPO_POST_MIX);
        assert!(!state.is_pre_mix());
        assert!(state.is_post_mix());
    }
    ...
    fn apo_object_state_lock_unlock() {
        let mut state = ApoObjectState::new(super::super::reg_props::CLSID_VXAPO_PRE_MIX);
