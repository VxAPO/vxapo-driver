...
use crate::utils::reg_read::RegValue;
use crate::com::reg_props::{CLSID_VXAPO_PRE_MIX, CLSID_VXAPO_POST_MIX};
use crate::device::endpoint::{EndpointInfo, query_endpoint};
use crate::device::format::{AudioFormat, read_audio_format};
...
mod tests {
    use super::*;
    use crate::device::slots::{ApoSlot, SlotValue, INSTALL_VERSION_LEGACY};
    use crate::device::endpoint::{EndpointState, Flow};
