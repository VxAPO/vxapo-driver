...
$wav = $null
if (Test-Path "$env:WINDIR\Media\tada.wav") {
    $wav = "$env:WINDIR\Media\tada.wav"
} elseif (Test-Path "$env:WINDIR\Media\Windows Notify.wav") {
    $wav = "$env:WINDIR\Media\Windows Notify.wav"
} elseif (Test-Path "$env:WINDIR\Media\chimes.wav") {
    $wav = "$env:WINDIR\Media\chimes.wav"
}
